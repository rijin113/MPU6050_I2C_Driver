...
int main(void)
{
  ...
  {
	  printf("MPU6050 is not ready. Try again \n");
  }

  uint8_t gyro_config = 0b00001000;
  HAL_StatusTypeDef gyro_ready = HAL_I2C_Mem_Write(&hi2c1, 0b1101000 << 1, 27, 1, &gyro_config, 1, 100);
